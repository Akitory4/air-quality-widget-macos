...
final class AQIClassifierTests: XCTestCase {
    ...
    func test_usEpa_boundaries() {
        ...
        XCTAssertEqual(AQIClassifier.category(for: 101, standard: .usEpa), .moderate)
        XCTAssertEqual(AQIClassifier.category(for: 150, standard: .usEpa), .moderate)
        XCTAssertEqual(AQIClassifier.category(for: 151, standard: .usEpa), .poor)
        XCTAssertEqual(AQIClassifier.category(for: 200, standard: .usEpa), .poor)
        XCTAssertEqual(AQIClassifier.category(for: 201, standard: .usEpa), .veryPoor)
